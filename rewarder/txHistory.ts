...
export async function* getTransactionHistory(con: InstanceType<typeof Connection>, pubkey: InstanceType<typeof PublicKey>, pageSize: number | undefined = undefined) {
    let page = 1;
    let txs: any;
    let last;
    do {
